...
namespace myTiles {
    ...
    helpers._registerFactory("tilemap", function(name: string) {
        switch(helpers.stringTrim(name)) {
            case "level1":
            case "level1":return tiles.createTilemap(hex``, img`
...
`, [myTiles.transparency16,myTiles.tile1,myTiles.tile2,myTiles.tile7], TileScale.Sixteen);
            case "level3":
            case "level3":return tiles.createTilemap(hex``, img`
...
2..2..2..2..2..2...2
22222222222222222222
`, [myTiles.transparency16,myTiles.tile5,myTiles.tile9,myTiles.tile10,myTiles.tile11,myTiles.tile12,myTiles.tile13], TileScale.Sixteen);
            case "level2":
            case "level2":return tiles.createTilemap(hex``, img`
...
2.............2..........2
22222222222222222222222222
`, [myTiles.transparency16,myTiles.tile5,myTiles.tile3,myTiles.tile6,myTiles.tile8], TileScale.Sixteen);
            case "level4":
